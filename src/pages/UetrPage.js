...
function UetrPage() {
    ...
    return (
        <Box className='uetrpage' bgcolor="#fff" height='100%' marginLeft='3%' mb="50px" borderRadius='5px' sx={{ boxShadow: "15px 15px 33px 0px rgba(0,0,0,0.37)",}}>
